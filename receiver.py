...
## Run commands. 
TCPcommand = "gst-launch-1.0 -v tcpclientsrc host={0} port={1} ! gdpdepay ! rtph264depay ! avdec_h264 ! videoconvert ! fpsdisplaysink sync=false text-overlay=true"
UDPcommand = "gst-launch-1.0 -e -v udpsrc address={0} port={1} ! application/x-rtp, payload=96 ! rtpjitterbuffer ! rtph264depay ! avdec_h264 ! fpsdisplaysink sync=false text-overlay=true"
